...
async function importAllData() {
  ...
  try {
    ...
    for (const product of products.slice(0, 20)) { // First 20 products as suppliers
      await client.query(`
        INSERT INTO suppliers (name, email, phone, status, address, contact_person)
        VALUES ($1, $2, $3, $4, $5, $6)
    ...
    for (const product of products) {
      await client.query(`
        INSERT INTO products (sku, name, description, price, cost, stock_quantity, category, status)
      ...
      `, [
        ...
        parseFloat(product.price) * 0.7, // Assume 30% markup
